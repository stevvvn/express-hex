...
module.exports = ({ log, launchPath, conf, app, http, express, action }: { log: Logger, launchPath: string, conf: Conf, app: any, express: any, action?: (mwPath: string, params: any) => void }): Promise<void> => {
